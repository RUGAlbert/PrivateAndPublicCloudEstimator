...
def calculateEmmisionsOfServer(serverInfo : dict) -> DataFrame:
    ...
    result = result[['eNetwork', 'eNetworkTotal', 'mu','eServerStatic', 'eServerDynamic', 'eNetworkStatic', 'eNetworkDynamic', 'eCoolingStatic', 'eCoolingDynamic', 'scope1', 'scope2Lower', 'scope2Upper', 'scope3', 'TCFPLower', 'TCFPUpper', 'ci']]
